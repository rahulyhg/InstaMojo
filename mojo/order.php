  ...
  <body>
    <div class="container">
      ...
      <div class="page-header">
        ...
        <p class="lead">A test payment integration for instamojo payment gateway. Written by $am</p>
      </div>
		...
		<input type="submit" class="btn btn-primary btn-lg" value="Click here to Pay Rs:<?php echo $prd_price; ?> ">
